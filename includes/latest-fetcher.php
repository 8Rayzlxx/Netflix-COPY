...
include 'db_connection.php';
  ...
  $newrecords = mysqli_query($conn,$newim);
    while($fetchr = mysqli_fetch_assoc($newrecords)){
      ...
      echo"<form action='../pages/movie.php' method='POST'>";
      echo"<div class='col'>";
      echo "<img src='../thumbnails/".$fetchr['imgpath']."' height='250' width='200' style='margin-top: 30px;margin-left:50px;margin-right:20px;' />";
        echo"<div class='noob'>";
